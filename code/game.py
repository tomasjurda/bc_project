...
class Game:
    def __init__(self):
        ...
        self.player = Player(
            (0, 0),
            {},
            pygame.image.load(join("graphics", "models", "Player.png")).convert_alpha(),
        )
        ...
        # load maps
        self.levels = {
            "tutorial": Level("maps/tutorial_map.tmx", self.quests),
            "crossroad": Level("maps/crossroad_map.tmx", self.quests),
            "arena": Level("maps/arena_map.tmx", self.quests),
            "city": Level("maps/city_map.tmx", self.quests),
        }
